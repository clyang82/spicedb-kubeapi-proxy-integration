module github.com/clyang82/spicedb-kubeapi-proxy-integration

go 1.24.4

require (
	github.com/authzed/authzed-go v1.4.1
	github.com/authzed/spicedb-kubeapi-proxy v0.2.2-0.20250813210043-5bc78c4af68d
	k8s.io/api v0.33.1
...
require (
	...
	github.com/authzed/spicedb v1.45.1 // indirect
...
replace (
	github.com/authzed/spicedb => github.com/authzed/spicedb v1.45.1
